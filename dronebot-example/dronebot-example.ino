...
void loop(){
  ...
  servo_x = int(map(angle_pitch_output, -10, 10, 0, 180));
  servo_y = int(map(angle_roll_output, 0, 20, 0, 180));
  servo_z = int(map(angle_yaw_output, 0, 20, 0, 180));
  servo_yz = servo_y + servo_z;
  Serial.print(" | yz = "); Serial.print(servo_yz);
  Serial.print(" | Y = "); Serial.print(servo_y);
